          ...
          Scaffold(
              appBar: AppBar(
                title: Container(
                  ...
                  child: TextField(
                    /*onChanged: (value) {
                     */ /*controller.categorySearch = controller.categories!.where((element) => element.name!.toLowerCase().contains(value.toLowerCase())).toList();
                    print('skhfdjhfjh' + controller.categorySearch.length.toString());
                        ...
                        controller.categories?.length ?? 0,
                            ...
                            FilterChip(
                              label: Text(
                                ...
                                style: TextStyle(
                                  color: controller.categories?[index].isSelected ??
                                      false
                                      ? Colors.white
                                      : Colors.black,
                                ),
